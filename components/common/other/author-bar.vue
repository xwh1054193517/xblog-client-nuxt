      ...
      <div class="fixed-item flex flex-col items-center">
        ...
        <div class="perInfo flex flex-col items-center text-purple-400">
          <div class="pos flex items-center">
            <span role="img" aria-label="environment" class="block mr-1"
              ><svg
        ...
        <div v-if="tags.length!=0" class="toSay w-full py-4 my-2">
        ...
        <div class="ThreeDbox">
          <div class="cube">
            <div class="box1" data-key="1"><img :src="avatar" /></div>
            <div class="box2" data-key="2"><img :src="avatar" /></div>
            <div class="box3" data-key="3"><img :src="avatar" /></div>
            <div class="box4" data-key="4"><img :src="avatar" /></div>
            <div class="box5" data-key="5"><img :src="avatar" /></div>
            <div class="box6" data-key="6"><img :src="avatar" /></div>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      ip: null,
      add: null,
      avatar:'http://xblog-pic-1305549463.cos.ap-guangzhou.myqcloud.com/authors/EternalStar-avatar.jpg'
    };
  },
