<template>
  <div class="article-container ">
    <!-- 文章头部 -->
    <div class="article-header flex justify-center items-center box-border overflow-hidden relative "
      ...
      <div class="header-wrapper relative w-full max-w-6xl box-border  my-0 mx-auto">
        <div class="content ">
          <div class="taglist flex justify-center flex-wrap w-full my-1">
            <tag-item class="showBig cursor-pointer"
    ...
    <div class="article-box w-full box-border ">
      ...
      <div class="article-foot flex justify-between items-center">
        ...
        <div class="likeBtn flex justify-center items-center cursor-pointer flex-row"
             @click="likeArticle">
          <span :class="{'isLiked':isLiked}"><svg t="1654935705926"
                 class="icon"
                 viewBox="0 0 1024 1024"
                 version="1.1"
                 xmlns="http://www.w3.org/2000/svg"
...
export default {
  ...
  computed: {
    ...mapState('article', ['article', 'comment', 'loading']),
    mdContent() {
  ...
  mounted() {
    console.log(this.id, this.like, this.article)
  },
}
</script>
